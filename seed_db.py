...
materials_data = [
    {
        ...
        'image_url': '/static/images/mat_mineral_plaster.jpg',
        'order': 1,
    },
    {
        'slug': 'microcement',
        ...
        'image_url': '/static/images/mat_microcement.jpg',
        'order': 2,
    },
    {
        'slug': 'mural',
        ...
        'image_url': '/static/images/mat_mural.jpg',
        'order': 3,
    },
    {
        'slug': 'gold',
        ...
        'image_url': '/static/images/mat_gold.jpg',
        'order': 4,
    },
    {
        'slug': 'basrelief',
    ...
    },
    {
        ...
        'image_url': '/static/images/mat_venetian.jpg',
        'order': 6,
    },
]

for m in materials_data:
    DecorativeMaterial.objects.update_or_create(
        slug=m['slug'],
        defaults=m
    )
